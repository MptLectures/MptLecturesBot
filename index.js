...
bot.command("how_to_use", async (ctx) => {
    await ctx.reply(`
    ❔Этот бот умеет❔:
    1. /queue_start -- создать новую очередь на сдачу практических работ⚒️
    2. /create_target_and_total -- сгенерировать цель и вывод ✍️ для для вашей практической работы 📝
    3. Вы можете перейти в личку бота👤, и открыть веб приложение с лекциями второго курса📚, специализации "программист"`)
})
